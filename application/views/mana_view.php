							...
							<div class="modal-dialog modal-lg" role="document">
								<div class="modal-content">
									...
									<div class="modal-body"> -->
										<form action="<?php echo base_url().'equipo_controller/ingresar' ?>" method="POST" class="mx-auto" onsubmit="return vequi()">
											<div class="row">
												<div class="col">
											...
											<div class="col">
												<div class="input-group">
													...
													<input type="text"   class="form-control" aria-label="Small" readonly aria-describedby="inputGroup-sizing-sm" name="fecha" id="fecha">
												</div>
											</div>
											</div>
											<div class="row">
